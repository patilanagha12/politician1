            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                                 ...
                                 <h1><center>होणारी कामे </center></h1>
                ...
                <button data-toggle="modal" data-target="#addwork" class="btn btn-success pull-right">होणारी जतन करा </button>
...
<!-- Modal -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">होणारी कामे</h4>
        </div>
 ...
 <input type="text" name="bookId" id="bookId" value=""  readonly=""   hidden="hidden" />
        ...
        <input type="text" name="name" id="name" class="form-control col-md-7 col-xs-12"  placeholder="कामाचे नाव">
         ...
         <label class="control-label col-md-4 col-sm-3 col-xs-12">वर्णन </label>
